...
import { ProjectClassCoursework } from './pages/ProjectClassCoursework';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    link.rel = 'icon';
    link.href =
      'https://cdn.myportfolio.com/9ad4e767-db52-4662-a159-aed2a549175d/8364bb76-134a-4a86-af12-e41af70a6e1e_rw_600.png?h=4c0043d0f25e8e49b70bf23da884773e';
    ...
    <BrowserRouter>
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-orange-50 dark:from-gray-950 dark:via-gray-900 dark:to-black transition-colors duration-300">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-40 right-20 w-[500px] h-[500px] bg-gradient-to-br from-orange-300/20 to-rose-300/20 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: '1s' }}
          ></div>

          <div
            className="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-br from-pink-400/20 to-rose-400/20 rounded-full blur-3xl animate-pulse"
        ...
        <div className="relative z-10">
          ...
          <Routes>
            ...
            <Route
              path="/project/touchdowntravels"
              element={<ProjectTouchdownTravels />}
            />
            ...
            <Route
              path="/project/stampstudentunion"
              element={<ProjectStampStudentUnion />}
            />

            <Route
              path="/project/servpro"
              element={<ProjectServpro />}
            />

            <Route
              path="/project/class-coursework"
              element={<ProjectClassCoursework />}
            />
